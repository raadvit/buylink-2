...
if (!document.getElementById('nav-link-resets')) {
  ...
  s.textContent = 'a.topnav__logo,a.nav-link{text-decoration:none;color:inherit} a.btn{text-decoration:none} .nav-link{color:var(--ink)} .nav-link.is-active{background:var(--surface-2);color:var(--ink)}';
    ...
    <div class="topnav__right">
      ...
      <div class="user-menu" tabindex="0" role="button" aria-label="Uživatelské menu">
        ...
        <div class="user-menu__meta">
          ...
          <span class="user-menu__role">admin</span>
        </div>
