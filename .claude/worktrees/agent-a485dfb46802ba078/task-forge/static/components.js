...
//     active: 'open',
//     agentBanner: 'Agent právě reviewuje <b>2 stories</b>…',  // optional
//   })

function renderFilterTabs({ tabs = [], active = '', agentBanner = '' } = {}) {
  ...
  return `
    <div class="table" role="table">
      <div class="table__head" role="row">
        ...
        <div role="columnheader" class="ta-right col-updated">Upraveno</div>
      </div>
